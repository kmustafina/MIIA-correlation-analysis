function h = plotgaussfit(a, corrFun, pixelsize, whitenoise);
...
set(m,'FaceAlpha',0)
set(gca,'Color','none')
xlabel('\eta (\mum)','FontSize',20,'Color',[1 1 1])
ylabel('\xi (\mum)','FontSize',20,'Color',[1 1 1])
zlabel('r_{12}(\xi,\eta)','FontSize',20,'Color',[1 1 1])
